...
@Entity
@Table(name = "CEP_USER", uniqueConstraints={@UniqueConstraint(columnNames = {User.COLUMN_USERNAME , HistoryPK.COLUMN_HISTORY})})
@Getter
@Setter
@NoArgsConstructor
...
public class User extends HistorizableEntity {
	...
	/**
	 * Event that can be sent when a {@link User} bean is created/updated/deleted.
	 */
	@AllArgsConstructor
